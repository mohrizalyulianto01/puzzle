    ...
    private static void display(Context context) {
        ...
        for (int i = 0; i < titleList.length; i++) {
            ...
            if (titleList[i].equals("0"))
                button.setBackgroundResource(R.drawable.huruf_a);
            else if (titleList[i].equals("1"))
                button.setBackgroundResource(R.drawable.huruf_b);
            else if (titleList[i].equals("2"))
                button.setBackgroundResource(R.drawable.huruf_c);
            else if (titleList[i].equals("3"))
                button.setBackgroundResource(R.drawable.huruf_d);
            else if (titleList[i].equals("4"))
                button.setBackgroundResource(R.drawable.huruf_e);
            else if (titleList[i].equals("5"))
                button.setBackgroundResource(R.drawable.huruf_f);
            else if (titleList[i].equals("6"))
                button.setBackgroundResource(R.drawable.huruf_g);
            else if (titleList[i].equals("7"))
                button.setBackgroundResource(R.drawable.huruf_h);
            else if (titleList[i].equals("8"))
                button.setBackgroundResource(R.drawable.huruf_i);
